...
public class PeerReviewSystemTest {
    ...
    @Test
    public void testGetReviewsForNonExistentTask() {
        PeerReviewSystem system = new PeerReviewSystem();
        Task task = new Task("nonexistent", "This task does not exist");
    ...
    @Test
    public void testGetReviewsByNonExistentReviewer() {
        PeerReviewSystem system = new PeerReviewSystem();
        List<Review> reviews = system.getReviewsByReviewer("nonexistent");
